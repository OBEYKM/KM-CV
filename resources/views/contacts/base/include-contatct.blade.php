<section class="w3l-contact py-5" id="contact">
        ...
        <div class="row contact-block">
            <div class="col-md-6 contact-left pe-lg-5">
                ...
                <div class="cont-details">
                    <p><i class="fas fa-map-marker-alt"></i>Mozambique,Matola</p>
                    <p><i class="fas fa-phone-alt"></i><a href="tel:+(258) 84 845 1054">+(258) 84 845 1054</a></p>
                    <p><i class="fas fa-envelope-open-text"></i><a href="lykesmathew619@gmail.com"
                            class="mail">lykesmathew619@gmail.com</a></p>
                </div>
   ...
   <div class="map-iframe">
    <iframe
        ...
        src="https://www.google.com/maps/embed?pb=@-25.9650508,32.4647345,20.1z/data=!5m1!1e1"
